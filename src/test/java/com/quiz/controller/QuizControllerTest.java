...
class QuizControllerTest {
    ...
    void 리스트조회() throws Exception {
        ...
        mockMvc.perform(get("/quiz?page=1")
                ...
                .andExpect(jsonPath("$.quizInfo.length()").value(20L))
                .andExpect(jsonPath("$.quizInfo[0].title").value("제목100"))
                .andExpect(jsonPath("$.quizInfo[1].title").value("제목99"))
                .andExpect(jsonPath("$.quizInfo[2].title").value("제목98"))
                .andExpect(jsonPath("$.quizInfo[3].title").value("제목97"))
                .andExpect(jsonPath("$.quizInfo[4].title").value("제목96"))
                .andExpect(jsonPath("$.quizInfo[5].title").value("제목95"))
                .andExpect(jsonPath("$.quizInfo[6].title").value("제목94"))
                .andExpect(jsonPath("$.quizInfo[7].title").value("제목93"))
                .andExpect(jsonPath("$.quizInfo[8].title").value("제목92"))
                .andExpect(jsonPath("$.quizInfo[9].title").value("제목91"))
                .andExpect(jsonPath("$.quizInfo[10].title").value("제목90"))
    ...
    void 리스트조회_페이징_검색() throws Exception {
        ...
        mockMvc.perform(get("/quiz?page=0&type=title&content=0")
                ...
                .andExpect(jsonPath("$.quizInfo[0].title").value("제목100"))
                .andExpect(jsonPath("$.quizInfo[1].title").value("제목90"))
                .andExpect(jsonPath("$.quizInfo[2].title").value("제목80"))
                .andExpect(jsonPath("$.quizInfo[3].title").value("제목70"))
                .andExpect(jsonPath("$.quizInfo[4].title").value("제목60"))
                .andExpect(jsonPath("$.quizInfo[5].title").value("제목50"))
                .andExpect(jsonPath("$.quizInfo[6].title").value("제목40"))
                .andExpect(jsonPath("$.quizInfo[7].title").value("제목30"))
                .andExpect(jsonPath("$.quizInfo[8].title").value("제목20"))
                .andExpect(jsonPath("$.quizInfo[9].title").value("제목10"))
